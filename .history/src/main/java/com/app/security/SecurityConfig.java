...
public class SecurityConfig {
    ...
    private static final String ROLE_ADMIN = "LYNCAS_ADMIN";
    private static final String ROLE_CAST_MEMBERS = "LYNCAS_USER";
    private static final String ROLE_CATEGORIES = "LYNCAS_CATEGORIES";
    private static final String ROLE_GENRES = "LYNCAS_GENRES";
    private static final String ROLE_VIDEOS = "LYNCAS_VIDEOS";
